...
const FooterCom = () => {
  return (
    <Footer container className="border border-t-8 border-black-300 ">
        ...
        <div className="">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            ...
            <Footer.LinkGroup col>
                ...
                <Footer.Link href="/" target="_blank" rel="noopener noreferrer">Twitter</Footer.Link>
            </Footer.LinkGroup>
            </div>
            <div>
            ...
            <Footer.LinkGroup col>
                ...
                <Footer.Link href="/" target="_blank" rel="noopener noreferrer"></Footer.Link>
            </Footer.LinkGroup>
            </div>
          </div>
        </div>
